...
$cm_krb_authenticator_texts['en_US'] = array(
  ...
  'pl.krbauthenticator.info'           => 'Your new password must be between %1$s and %2$s characters in length.',
  ...
  'pl.krbauthenticator.ssr.info'       => 'Enter a verified email address or registered identifier to proceed.</p>If you still know your password, click <a href="%1$s">here</a> to directly select a new password.',
  ...
  'pl.krbauthenticator.usernamereminder.info' => 'Enter a verified email address or registered identifier to proceed.',
