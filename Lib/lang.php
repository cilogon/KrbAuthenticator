...
$cm_krb_authenticator_texts['en_US'] = array(
  ...
  'pl.krbauthenticator.info'           => 'Your new password must be between %1$s and %2$s characters in length, and include characters from three of the following: lowercase letter, uppercase letters, numbers, and symbols.',
