<?php
/**
 * COmanage Registry Kerberos Remind (Principal Reminder) View
 *
 ...
 */
  ...
  $params = array('title' => _txt('pl.krbauthenticator.token.usernamereminder'));
...
<div class="ui-state-highlight ui-corner-all co-info-topbox">
  ...
  <strong><?php print _txt('pl.krbauthenticator.usernamereminder.info'); ?></strong>
</div>
  ...
  <li>
    <div class="field-name vtop">
      <div class="field-title">
        <?php print _txt('pl.krbauthenticator.remind.q'); ?>
      </div>
    </div>
