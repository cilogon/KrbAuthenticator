<?php
/**
 * COmanage Registry Kerberos SSR (Self Service Reset) View
 *
 ...
 */
  ...
  $params = array('title' => _txt('pl.krbauthenticator.token.ssr'));
  ...
  print $this->Form->create('Krb', $options);
...
<div class="ui-state-highlight ui-corner-all co-info-topbox">
  ...
  <strong><?php print _txt('pl.krbauthenticator.ssr.info', array($vv_ssr_authenticated_url)); ?></strong>
</div>
  ...
  <li>
    <div class="field-name vtop">
      <div class="field-title">
        <?php print _txt('pl.krbauthenticator.ssr.q'); ?>
      </div>
    </div>
